...
OverlayWindow::~OverlayWindow() { getContentManager()->removeContentSizeObserver(this); }
...
auto OverlayWindow::toggleWindowTool(bool isToolWindow) -> void { pImpl_->toggleWindowTool(isToolWindow); }
...
auto OverlayWindow::getCurrentScreenResolution() -> std::pair<int, int> { return pImpl_->getCurrentScreenResolution(); }

auto OverlayWindow::makeWindowFrameless() -> void { pImpl_->makeWindowFrameless(); }
}  // namespace palantir::window