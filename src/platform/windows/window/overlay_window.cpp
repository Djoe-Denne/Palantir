...
namespace {
auto CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
    -> LRESULT {
  auto *window = reinterpret_cast<OverlayWindow *>(GetWindowLongPtrW(
...
public:
  ...
  void create() {
    ...
    hwnd =
        CreateWindowExW(WS_EX_LAYERED | WS_EX_TOPMOST, L"InterviewCheaterClass",
                        L"Interview Cheater", WS_OVERLAPPEDWINDOW,
