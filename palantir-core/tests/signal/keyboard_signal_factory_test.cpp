...
class KeyboardSignalFactoryTest : public Test {
protected:
    void SetUp() override {
        ...
        signalFactory = std::make_shared<KeyboardSignalFactory>(mockInputFactory);
    ...
    std::shared_ptr<KeyboardSignalFactory> signalFactory;

    std::shared_ptr<MockInputFactory> mockInputFactory;
    std::shared_ptr<MockCommandFactory> mockCommandFactory;
};

TEST_F(KeyboardSignalFactoryTest, CreateSignals_NoCommands_ReturnsEmptyVector) {
...
TEST_F(KeyboardSignalFactoryTest, CreateSignals_WithValidCommand_ReturnsSignal) {
...
TEST_F(KeyboardSignalFactoryTest, CreateSignals_WithInvalidCommand_ThrowsException) {
...
TEST_F(KeyboardSignalFactoryTest, CreateSignals_MultipleCommands_ReturnsMultipleSignals) {
